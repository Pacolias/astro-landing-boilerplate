...
export const ContactForm: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-10 md:py-24 bg-slate-100 dark:bg-slate-950 transition-colors border-b border-slate-200 dark:border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-16 items-start">
          ...
          <div className="space-y-3 md:space-y-8 lg:sticky lg:top-24">
            ...
            <div className="flex flex-col sm:flex-row md:flex-col gap-2.5 md:gap-6">
              <div className="flex items-center gap-3 md:gap-4">
                <div className="w-9 h-9 md:w-12 md:h-12 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center text-slate-600 dark:text-slate-300 shadow-sm shrink-0">
              ...
              <form onSubmit={handleSubmit} className="space-y-2.5 md:space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 md:gap-6">
                  <div className="space-y-1">
                    <label htmlFor="name" className="block text-xs md:text-sm font-medium text-slate-700 dark:text-slate-300">
                      Full Name
                    </label>
                    <input
                      type="text"
                      ...
                      name="name"
                      required
                      className="w-full px-3.5 md:px-4 py-2 md:py-3 text-sm md:text-base rounded-lg md:rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                      placeholder="John Doe"
                    />
                  </div>
                  <div className="space-y-1">
                    <label htmlFor="email" className="block text-xs md:text-sm font-medium text-slate-700 dark:text-slate-300">
                      Email
                    </label>
                    <input
                      type="email"
                ...
                <div className="space-y-1">
                  <label htmlFor="subject" className="block text-xs md:text-sm font-medium text-slate-700 dark:text-slate-300">
                    Subject
                  </label>
                  <input
                    type="text"
                ...
                <div className="space-y-1">
                  <label htmlFor="message" className="block text-xs md:text-sm font-medium text-slate-700 dark:text-slate-300">
                    Message
                  </label>
                  <textarea
                    id="message"
                    ...
                    rows={3}
                    required
                    className="w-full px-3.5 md:px-4 py-2 md:py-3 text-sm md:text-base rounded-lg md:rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all resize-none"
                ...
                <button
                  ...
                  className="w-full inline-flex justify-center items-center gap-3 px-8 py-2.5 md:py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs uppercase tracking-widest rounded-full shadow-lg shadow-blue-500/25 transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {status === 'submitting' ? (
                    <>
                ...
                <p className="text-[11px] md:text-xs text-center text-slate-500 dark:text-slate-400 mt-2 md:mt-4">
