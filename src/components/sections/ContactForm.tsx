...
export const ContactForm: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-slate-100 dark:bg-slate-950 transition-colors border-b border-slate-200 dark:border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-start">

          {/* Left Contact Information */}
          <div className="space-y-5 md:space-y-8 lg:sticky lg:top-24">
            <div>
              <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight md:text-3xl lg:text-4xl mb-2 md:mb-4">
            ...
            <div className="space-y-4 md:space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center text-slate-600 dark:text-slate-300 shadow-sm shrink-0">
                ...
                <div>
                  ...
                  <a href={`mailto:${SITE_CONFIG.contactEmail}`} className="text-base md:text-lg font-bold text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
              ...
              {SITE_CONFIG.contactPhone && (
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${SITE_CONFIG.contactPhone}`} className="text-base md:text-lg font-bold text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                      {SITE_CONFIG.contactPhone}
                    </a>
                  </div>
                </div>
          ...
          {/* Right Form */}
          <div className="bg-white dark:bg-slate-900 p-6 md:p-10 rounded-2xl md:rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-xl shadow-slate-900/5 dark:shadow-none">
            {status === 'success' ? (
